$(function(){
	...
	$(".file").change(function(){	 
		...
		console.log(fileList.length+"  "+totalNum);
	...
	$(".file_2").change(function(){
		var idFile = $(this).attr("id");
		var file = document.getElementById(idFile);
		var imgContainer = $(this).parents(".z_photo_2"); //存放图片的父亲元素
		var fileList = file.files; //获取的图片文件
		var input = $(this).parent();//文本框的父亲元素
		var imgArr = [];
		//遍历得到的图片文件
	...
	//  改变
   	$(".file_3").change(function(){
		...
		var idFile = $(this).attr("id");
		var file = document.getElementById(idFile);
		if(imgName == file.files[0].name){
			setTimeout(function(){
				alert("不能添加相同的图片");
				$(".getImgDiv3>section").eq(0).remove();
			},1000);
		}
		imgName = file.files[0].name;
		var imgContainer = $(this).parents(".z_photo_3"); //存放图片的父亲元素
		var fileList = file.files; //获取的图片文件
		var input = $(this).parent();//文本框的父亲元素
		var imgArr = [];
		//遍历得到的图片文件
